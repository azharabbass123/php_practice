          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3">
              ...
              <?php if ($_SESSION['user'] ?? false) : ?> 
                ...
                <?php else : ?>
                  <a href="register" class="<?php echo ($_SERVER['REQUEST_URI'] === '/php_practice/dynamic_webpages/register') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Register</a>
                  <a href="login" class="<?php echo ($_SERVER['REQUEST_URI'] === '/php_practice/dynamic_webpages/login') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Log In</a>
                    <?php endif; ?>
              </div>
