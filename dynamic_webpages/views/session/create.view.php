            ...
            <div class="m-7">
                <form method="POST">
                    <div class="mb-6">
                        ...
                        <input type="email" name="email" value="<?= old('email') ?>" id="email" placeholder="you@company.com" class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" />
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-red-500 text-xs mt-2"><?= $errors['misMatch'] ?></p>
                        <?php endif; ?>
                    ...
                    <div class="mb-6">
                        <button type="submit" class="w-full px-3 py-3 text-white bg-indigo-500 rounded-md focus:bg-indigo-600 focus:outline-none">Log In</button>
                    </div>
